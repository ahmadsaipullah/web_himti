      ...
      <section id="team" class="team">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/kahim.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/wakahim.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Mulyana</h4>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/sekretaris1.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Anik Sofiatun</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/sekretaris2.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/bendahara.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Ahmad Romli</h4>
                    <span>Bendahara</span>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/sdm.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Okky Pratama</h4>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/kominfo.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
                    <h4>Nanda Aulia</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/organisasi.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/litbang.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              <div class="member">
                <img src="{{ asset('assets/ninestars/assets/img/team/danus.jpg')}}" class="img-fluid" alt="">
                <div class="member-info">
                  <div class="member-info-content">
          ...
          <ul class="faq-list">
            <li data-aos="fade-up" data-aos-delay="100">
              ...
              <div id="faq1" class="collapse show">
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. At odit quaerat labore, magnam aliquid ea
                  aliquam, sed, accusantium est mollitia magni aperiam et doloribus similique ratione rerum beatae quos
                  explicabo?
                </p>
              </div>
            </li>
            <li data-aos="fade-up" data-aos-delay="200">
              ...
              <div id="faq2" class="collapse">
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet similique et ad, quas vero nulla
                  repellendus dignissimos omnis. Vero officia praesentium autem dolore natus sit unde molestias qui
