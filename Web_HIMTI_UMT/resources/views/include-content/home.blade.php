      ...
      <section class="features-overview" id="features-section">
        ...
        <div class="d-md-flex justify-content-between">
          ...
          <div class="grid-margin d-flex justify-content-center">
            <div class="features-width">
              <img src="{{ asset('assets/images/clapperboard.png')}}" height="65" width="65" alt="" class="img-icons">
          ...
          <div class="grid-margin d-flex justify-content-end">
            <div class="features-width">
              <img src="{{ asset('assets/images/computer.png')}}" height="65" width="65" alt="" class="img-icons">
    ...
    <section class="digital-marketing-service" id="digital-marketing-section">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 col-xl-6 p-0">
                <p class="py-4 m-0 text-muted">Macam-macam Sharing yang diadakan oleh HIMTI.</p>
                <p class="font-weight-medium text-muted"> {{$item->deskripsi}} </p>
            </div>
            </div>
        <div class="col-12 col-lg-5 p-0 img-digital grid-margin grid-margin-lg-0" data-aos="fade-left">
                <img src="{{ Storage::url($item->image) }}" alt="" height="336" width="306" class="img-fluid">
            </div>
        </div>
<br><br>
 @endforeach
          ...
          <div class="row justify-content-center">
            <div class="col">
              <div class="col-md-12 text-center pb-5">
                <img src="{{ asset('assets/images/himti-klinik.png')}}" width="1100" alt="" class="img-fluid">
        ...
        <div class="row">
          <div class="owl-carousel owl-theme grid-margin">
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="{{ asset('assets/images/rajif.jpeg')}}" width="89" height="89" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="{{ asset('assets/images/viky.jpeg')}}" width="89" height="89" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="{{ asset('assets/images/asad.jpeg')}}" width="89" height="89" alt="" class="img-customer">
            ...
            <div class="card customer-cards">
              <div class="card-body">
                <div class="text-center">
                  <img src="{{ asset('assets/images/rangga.jpeg')}}" width="89" height="89" alt="" class="img-customer">
